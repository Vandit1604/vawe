...
// velocity-cut.js: cut-velocity advice; spectacle.js: the one exaggerated-moment resolver;
// pan-resolve.mjs: merges a scene's authored camera pans, moved in from core/layout because
// sequence.js's motionAt was already its only real dependency). The clock, the joints, and the cuts
// in time, grouped as one concern (W9). Each file still exports its own surface; nothing here
// composes them.
