...
const ANIM_AKA = {
  fade: ['opacity only', 'fade in', 'no movement entrance'],
  up: ['rise up', 'translate up and fade'],
  rise: ['rise up', 'translate up and fade'],
  pop: ['spring in', 'bounce in', 'overshoot pop'],
  scale: ['zoom in', 'grow from small'],
  lift: ['float up', 'lively entrance', 'staggered card lift'],
  defocus: ['blur out exit', 'soft focus fade'],
  'slide-left': ['enter from the right', 'slide in from the right side'],
  'slide-right': ['enter from the left', 'slide in from the left side'],
  'slide-up': ['slide in from below', 'rise from the bottom'],
  'slide-down': ['slide in from above', 'drop from the top'],
  wipe: ['wipe right', 'reveal left to right', 'clip reveal'],
  'wipe-right': ['reveal left to right', 'clip wipe right'],
  'wipe-left': ['reveal right to left', 'clip wipe left'],
  'wipe-down': ['reveal top to bottom', 'clip wipe down'],
  'wipe-up': ['reveal bottom to top', 'clip wipe up', 'bar chart reveal'],
  iris: ['circle reveal', 'iris open', 'circular wipe'],
  clock: ['clock wipe', 'radial reveal', 'sweep reveal'],
  none: ['no entrance', 'appear instantly', 'no animation'],
};
