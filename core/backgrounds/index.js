...
const BG_AKA = {
  ...
  paper: ['white background', 'editorial background', 'plain paper field'],
  soft: ['gentle light radial', 'soft glow backdrop', 'light radial wash'],
  accent: ['brand color field', 'loud accent background', 'accent radial'],
  accentPlain: ['flat accent color', 'solid brand color', 'plain brand field'],
  dotmatrix: ['halftone dots', 'printed dot pattern', 'newspaper dots'],
  mesh: ['gradient mesh', 'colour pool background', 'dark saturated mesh'],
  constellation: ['connected nodes', 'network graph background', 'data telemetry field'],
  spotlight: ['wandering light pool', 'moving spotlight', 'dark field with light'],
  dark: ['plain dark background', 'dark radial', 'quiet dark backdrop'],
  deep: ['deepest dark background', 'very dark radial', 'black-ish backdrop'],
  ink: ['dark pulsing dots', 'ink black background', 'dark accent dots'],
  black: ['pure black', 'true black background', 'solid black backdrop'],
  metallic: ['brushed metal', 'lit equaliser bars', 'shimmering light rods'],
  metallicSheen: ['quiet brushed metal', 'slow metallic sweep', 'subtle light rods'],
  gradientWash: ['mesh gradient wash', 'colour pool bleed', 'premium gradient background'],
  blobs: ['soft color blobs', 'airy gradient pools', 'separated color pools'],
  liquid: ['liquid light', 'flowing colour folds', 'brand colour liquid'],
  gradient: ['custom gradient background', 'agent gradient', 'hex colour gradient'],
};
