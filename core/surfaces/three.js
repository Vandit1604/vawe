...
//
// The determinism contract lives in core/surfaces/three-fx.js, read its header before adding a scene. The
...
// A three scene reads its OWN dials off the layer (core/surfaces/three-fx.js, where it is named `LL`), which is
...
// bodyColor…) off it, which is why core/surfaces/three-fx.js names the layer `LL` where `L` is taken.
