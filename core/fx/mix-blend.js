...
export const BLEND_REGISTRY = defineRegistry('blend mode', Object.fromEntries(
  ...
  slot: 'mixBlend',
  aka: {
    normal: ['no blend', 'plain composite', 'opaque'],
    multiply: ['darken like ink', 'multiply blend', 'stack two slides'],
    screen: ['lighten like light', 'screen blend', 'two projectors'],
    overlay: ['punch up contrast', 'overlay blend', 'contrast blend'],
    darken: ['darken blend', 'keep the darker pixel', 'darker of the two'],
    lighten: ['lighten blend', 'keep the lighter pixel', 'lighter of the two'],
    'color-dodge': ['dodge', 'blow out highlights', 'brighten hard'],
    'color-burn': ['burn', 'crush shadows', 'darken hard'],
    'hard-light': ['harsh light blend', 'hard light', 'spotlight blend'],
    'soft-light': ['soft light blend', 'diffuse light', 'gentle wash'],
    difference: ['invert overlap', 'glitch blend', 'subtract colors'],
    exclusion: ['soft difference', 'grey the midtones', 'muted invert'],
    hue: ['hue blend', 'recolor by hue', 'tint only'],
    saturation: ['saturation blend', 'richness only', 'colorfulness blend'],
    color: ['recolor a photo', 'color blend', 'tint and richness'],
    luminosity: ['luminosity blend', 'brightness only', 'inverse of color blend'],
    'plus-lighter': ['additive blend', 'add light', 'glow blend'],
  },
  blurbs: {
