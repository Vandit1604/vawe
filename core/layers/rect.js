...
// discarded is the failure mode this codebase hates most (engine-doctrine/MISTAKES.md #213), and here the input is
...
// (engine-doctrine/MISTAKES.md #213). `h` is read here rather than by the shared box helper. Everything else this
...
// is unambiguous, so honour it. engine-doctrine/MISTAKES.md #369.
