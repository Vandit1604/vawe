...
export const LOOK_AKA = {
  ...
  neon: ['sign light', 'neon glow', 'glowing colours'],
  dreamyHaze: ['soft focus', 'dreamy blur', 'romantic haze'],
  halationFilm: ['film halation', 'warm film glow', 'amber bloom'],
  angelic: ['heavenly light', 'blown out white', 'overexposed halo'],
  hologram: ['holographic', 'projected image', 'teal hologram'],
  glitchGlow: ['signal glitch', 'digital fault', 'broken signal'],
  super8: ['old film stock', 'super 8mm', 'home movie film'],
  crt: ['old tv screen', 'phosphor tube', 'tube television'],
  filmNoir: ['black and white drama', 'noir grade', 'monochrome film'],
  fadedPolaroid: ['old polaroid', 'sun-faded print', 'washed out photo'],
  nostalgia: ['memory look', 'warm faded photo', 'old snapshot'],
  cyberpunk: ['neon noir', 'magenta cyan grade', 'sci-fi city grade'],
  nightVision: ['night vision goggles', 'green night scope', 'image intensifier'],
  thermal: ['heat camera', 'thermal imaging', 'infrared grade'],
  lomo: ['plastic camera look', 'lomography', 'crushed saturated photo'],
  droneCinematic: ['subtle cinematic grade', 'aerial footage look', 'gentle film grade'],
  vintageAnamorphic: ['old cinema lens', 'anamorphic streaks', 'blue lens flare'],
  impact: ['frame hit', 'punch frame', 'impact flash'],
  timeFreeze: ['frozen moment', 'time stop', 'cold freeze frame'],
  glassWarp: ['through glass', 'warped glass', 'distorted glass look'],
  heatWarp: ['heat haze', 'air shimmer', 'tarmac heat'],
  melt: ['melting image', 'liquid distortion', 'dripping frame'],
  watercolor: ['painted look', 'watercolour paper', 'pigment on stock'],
  dreamSequence: ['drifting dream', 'surreal drift', 'dream haze'],
  rippleGlass: ['water ripple', 'rippling glass', 'underwater ripple'],
  emboss: ['embossed relief', 'stone rubbing', 'carved surface'],
  letterpress: ['ink pressed paper', 'letterpress print', 'pressed into stock'],
  chrome: ['polished metal', 'chrome finish', 'metallic surface'],
  edgeGlow: ['neon wire drawing', 'glowing outline', 'edge detect glow'],
  fatten: ['bolder type', 'chunky poster look', 'dilated highlights'],
};
