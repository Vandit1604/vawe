#!/usr/bin/env node
// .claude/hooks/code-quality.mjs — tell the author about a tangled function while they are still in it.
//
...
process.stdin.on('end', () => {
  ...
  process.stderr.write(
    ...
    + 'Refused by .claude/hooks/code-quality.mjs. Limits live in .oxlintrc.json.\n');
  process.exit(2);
});
