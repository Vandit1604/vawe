#!/usr/bin/env node
// .claude/hooks/scene-live.mjs — the four numbers CLAUDE.md argues from, measured on the film you just
...
// that speaks every time is a hook that gets turned off, which is .claude/hooks/vocabulary.mjs's
