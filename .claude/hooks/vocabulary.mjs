#!/usr/bin/env node
// .claude/hooks/vocabulary.mjs — a NEW named vocabulary should be a registry, and you should be told
...
// That argument is .claude/hooks/code-quality.mjs's, and this file is deliberately its twin.
//
