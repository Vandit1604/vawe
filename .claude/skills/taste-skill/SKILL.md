---
name: taste-skill
description: Anti-slop design-taste skill for hand-writing HTML in shortwave videos (hooks, CTAs, cards, heroes) and for landing pages / redesigns. Reads the brief, sets a committed design direction (Design Read + VARIANCE/MOTION/DENSITY dials), and enforces Anti-Default Discipline so output does not look templated. Load before hand-authoring any HTML; pair with the impeccable skill + `make slop`.
---
