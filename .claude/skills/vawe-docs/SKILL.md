...
| Doc | Reach for it when… | It answers |
|---|---|---|
| [docs/CRAFT/APPROVAL-STOPS.md](../../../docs/CRAFT/APPROVAL-STOPS.md) | "we built the whole thing and then it was rejected" | the points where the work gets shown before it is finished: concept · storyboard panels · style frames · the 85% draft |
