...
| [docs/MISTAKES.pending-docs.md](../../../docs/MISTAKES.pending-docs.md) | handing the docs-truth pass back, before appending to docs/MISTAKES.md | which stale commands and paths docs/MISTAKES.md still names, and what each should say |
