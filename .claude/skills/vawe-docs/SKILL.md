...
| Doc | Reach for it when… | It answers |
|---|---|---|
| [docs/CRAFT/APPROVAL-STOPS.md](../../../docs/CRAFT/APPROVAL-STOPS.md) | "we built the whole thing and then it was rejected" | the three points where the work gets shown before it is finished: concept · style frames · the 85% draft |
