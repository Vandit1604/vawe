---
name: vawe-launch
description: "The gated end-to-end pipeline for a launch/promo video: brief, capture, design-system, storyboard proposal, narration, authoring from recipes, build, and finalize (author-check, seam-check, judge, render). Load when a launch/promo/feature video needs the full orchestrated flow, not a single step; user-gated at steps 0, 3, 6."
---
