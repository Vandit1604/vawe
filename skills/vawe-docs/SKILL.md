...
| [docs/EVALS.md](../../docs/EVALS.md) | before or after any doctrine change (a new rule, a gate, a scaffold edit): did films actually get better? | the eval harness: six fixed briefs, one per video type, rendered to a contact sheet baseline, compared by a human, never scored |
