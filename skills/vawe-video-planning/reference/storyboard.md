...
from scratch is the #1 failure, a `plain-slideshow` (doctrine: `engine-doctrine/CRAFT/DIRECTION.md`,
"The ambition floor"; the gate that used to fail it was retired). Reach for a real device per beat,
