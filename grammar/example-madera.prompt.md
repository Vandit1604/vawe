...
the window defocuses (measured: x axis, gap 0.1s, see refs/example-madera/ideate-strips/joint-1-2.png)
...
both grow steadily larger frame to frame)
...
see refs/example-madera/ideate-strips/joint-4-5.png)
...
enters: from the bottom along the y axis (measured, gap 0.083s)
