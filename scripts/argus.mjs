...
// ═══ BEAT 3 · THE LEAK + FIX (10–16s) — Argus drafts a reply in your voice (the product reveal) ═══
L.push(T({ text: 'it drafts each reply in your voice.', x: 130, y: 150, size: 54, weight: 400, ls: '-0.03em', start: 10.2, duration: 5.8, anim: 'rise', enterDur: 0.5, cut: 'whip' }));
L.push(...tweetCard({ x: 150, y: 300, w: 720, name: 'a big account', handle: 'founder', initials: 'F', likes: '1.2k', reposts: '210',
  text: 'shipping is the only growth hack that compounds.', start: 10.4, dur: 5.6 }));
L.push(T({ text: 'argus · drafting in your voice', x: 1010, y: 320, font: 'mono', size: 20, weight: 500, color: COBALT, start: 11.4, duration: 4.6, anim: 'rise', enterDur: 0.4 }));
L.push(...chatBubble({ x: 1010, y: 370, w: 760, start: 11.6, dur: 4.4, messages: [
...
// ═══ BEAT 4 · THE LIFT (16–20s) — the metrics turn, your feed working ═══
L.push(T({ text: 'your feed, working.', x: 130, y: 200, size: 74, weight: 400, ls: '-0.03em', start: 16.2, duration: 3.8, anim: 'rise', enterDur: 0.5, cut: 'slide' }));
L.push(...kpiRow({ x: 140, y: 380, gap: 110, start: 16.6, dur: 3.4, items: [
  { value: '4.9%', label: 'reply rate' }, { value: '38k', label: 'impressions' }, { value: '+612', label: 'followers / wk' }] }));
L.push(...statCard({ x: 140, y: 620, w: 360, to: 612, label: 'new followers this week', delta: '+180%', deltaUp: true, start: 17.0, dur: 3 }));
L.push(...reactionBar({ x: 560, y: 690, start: 17.3, dur: 2.7, reactions: [{ emoji: '🔥', count: 128, mine: true }, { emoji: '🚀', count: 44 }, { emoji: '👀', count: 31 }] }));
L.push(...avatarStack({ x: 560, y: 620, size: 52, extra: 600, start: 17.5, dur: 2.5, avatars: [{ initials: 'JR' }, { initials: 'AL' }, { initials: 'KM' }, { initials: 'VS' }] }));
L.push(...barChart({ x: 1140, y: 330, w: 640, h: 400, color: COBALT, start: 16.8, dur: 3.2,
