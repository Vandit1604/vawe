...
// core/theme-contract.js), so a brand's look is a picture an author can glance at, not a JSON they have
...
execFileSync('node', ['core/validate.mjs', scenePath], { cwd: ROOT, stdio: 'inherit' });
