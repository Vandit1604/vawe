...
<body>
  <div class="wrap">
    ...
    <footer>
      Generated by <code>make gallery</code> from <code>formats/scene/examples.json</code>. Each card links to its scene source. Snippets: <code>docs/MOTION-SNIPPETS.md</code>.
    </footer>
  </div>
<script>
