...
// Run via `make site X=gallery`. Render the videos first (make video / beatsync), a missing video is warned, not fatal.
...
<body>
  <div class="wrap">
    ...
    <footer>
      Generated by <code>make site X=gallery</code> from <code>films/scene/examples.json</code>. Each card links to its scene source. Snippets: <code>engine-doctrine/MOTION-SNIPPETS.md</code>.
    </footer>
  </div>
<script>
