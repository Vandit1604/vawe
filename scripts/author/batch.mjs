// scripts/batch.mjs — DATA-DRIVEN VARIANTS. One template scene + an array of data rows → N rendered
...
//
// Usage: node scripts/batch.mjs <template.json> <data.json> [--render]
...
if (!tpl || !dataPath) { console.error('usage: node scripts/batch.mjs <template.json> <data.json> [--render]'); process.exit(2); }
