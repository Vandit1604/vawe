...
// THEME LOOK (W8, core/theme-contract.js): the brand's own fixed backdrop/cuts/scale/layout, read
...
} catch { /* an unreadable theme file is core/validate.mjs's job to report, not scaffold's */ }
