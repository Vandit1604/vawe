// scripts/scrub.mjs — the PREVIEW LOOP. Extract N frames evenly across a rendered video into one
...
//
// Usage: node scripts/scrub.mjs <mp4> [--n 24] [--cols 6] [--out /tmp/scrub.png]
...
if (!mp4) { console.error('usage: node scripts/scrub.mjs <mp4> [--n 24] [--cols 6] [--out sheet.png]'); process.exit(2); }
