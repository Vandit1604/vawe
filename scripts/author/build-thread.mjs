...
// finishes, so each cut is a comma. Grammar in docs/CRAFT/CONTINUITY-WITHOUT-AN-OBJECT.md, studied off
...
// docs/CRAFT/CONTINUITY-WITHOUT-AN-OBJECT.md warns against: props need weight.
...
const scene = {
  ...
  destination: 'reels',
  duration: DUR,
  authoringNote: 'Generated by scripts/author/build-thread.mjs. Held together by a SENTENCE, not a prop: '
    + 'nothing survives a cut, every beat is a new world and a new palette, and the film holds because no '
    + 'clause finishes. See docs/CRAFT/CONTINUITY-WITHOUT-AN-OBJECT.md.',
  authoring: {
