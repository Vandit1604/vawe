...
function renderDoc(all) {
  ...
  L.push('- `[ref: make study-tool X=grammar DOC=1]`: a measured catalog, not a gate. Nothing here blocks. Regenerate from `grammar/*.json` via `make study`; never hand-edit this file.');
  ...
  L.push('');
  L.push('> GENERATED by `make study-tool X=grammar DOC=1` from `grammar/*.json`. Do not edit this file: edit the JSON');
  ...
  L.push('make study-tool X=grammar DOC=1                             # regenerates this page');
  L.push('```');
  L.push('');
...
if (process.argv.includes('--check')) {
  ...
  console.error(`    Fix: make study-tool X=grammar DOC=1`);
  process.exit(1);
}
