...
export const GATES = {
  ...
  'backdrop-turn': () => ['quality/gates/backdrop-turn.mjs', ...words('D')],
  ...
  'designspec-check': () => ['quality/gates/designspec-check.mjs',
    ...
    ...flag('STRICT', '--strict')],
  'direction-floor': () => ['quality/gates/direction-floor.mjs', ...words('D'), ...flag1('STRICT', '--strict')],
  ...
  'ground-arc': () => ['quality/gates/ground-arc.mjs', ...words('D'), ...json()],
  ...
  'motion-floor': () => ['quality/gates/motion-floor.mjs', ...words('D'), ...json()],
  ...
  'pace-check': () => ['quality/gates/pace-check.mjs', ...words('D')],
