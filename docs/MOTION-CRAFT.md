...
group: process
codes: enter-and-retreat, front-loaded, linear-motion, monotone-timing, motion-monotony, profile, shared-start, stagger-total, tempo-flat, uneven-cascade, median-below-reference, sweep-static
applies-when: always
