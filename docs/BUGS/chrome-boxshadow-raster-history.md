...
hashes are the same ones `docs/MISTAKES.md` #531 recorded, so this reproduces unchanged.
...
sets, and it fixes a DIFFERENT defect (`docs/MISTAKES.md` #552, the supersampled raster). This one
