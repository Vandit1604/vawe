...
| `hang` | reaches almost the whole way (influence 85) at a dead stop, so the value HANGS at this key and the movement is crushed into the far end of the segment |
