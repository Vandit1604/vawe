...
| [docs/ROADMAP.md](ROADMAP.md) | proposing new engine work, or checking whether an effect already exists | the effect surface: what ships, what is queued, and the one rule that governs all of it |
