...
| [docs/CRAFT/SELECTION.md](CRAFT/SELECTION.md) | picking the transition/font/look/sting for a feeling | intent→effect (cited) · complete look/sting coverage · 8 named reference profiles |
...
| [docs/MISTAKES.pending-round.md](MISTAKES.pending-round.md) | you are about to fold the round-shapes and placement pass into docs/MISTAKES.md | why the envelope had no round curve and no position, why the shadow had a bearing but no place, and why the committed HTML fragments were stale |
