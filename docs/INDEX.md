...
| [docs/CRAFT/RECREATION.md](CRAFT/RECREATION.md) | recreating a specific reference video end to end ("make ours look like this") | the ordered loop: measure → capture → build (cinematic) → score → beat-sync → verify · the honest 1:1 ceiling |
...
| [docs/CRAFT/HTML-FRAGMENTS.md](CRAFT/HTML-FRAGMENTS.md) | you are writing an `html` layer by hand, or a fragment renders as a dead still and nothing says why | what a layer actually wraps · the four ways a fragment moves · the three things the engine refuses and what to use instead · the traps that cost a render each |
| [docs/CRAFT/IMAGERY.md](CRAFT/IMAGERY.md) | choosing image vs gradient, treating a photo, icons | the visual ladder · treatment→intent · licensing · icon choice |
