...
| [docs/MISTAKES.pending-worker.md](MISTAKES.pending-worker.md) | you are asked whether two renders of the same scene produce the same picture, or you hit a frame with content missing | why a 4-worker render damaged 4x as many frames as a 1-worker one; the deferred-image-decode race and its fix; what is still open |
