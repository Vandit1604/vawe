...
holds: warns (make audit, thin-hero; docs/CRAFT/LAYOUT.md and docs/CRAFT/TYPOGRAPHY.md)
...
measures a 40.4% median on landscape, with 82.9% of sampled frames under the 60% floor, and `make
audit` warns `thin-hero` below 55%. Type follows the same rule: a headline under 84px at a 1920px
canvas reads as a caption, not a headline.
