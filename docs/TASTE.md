...
| **Story-spine** | *Why these beats, in this order?* | the [`shortwave-video-planning`](../.claude/skills/shortwave-video-planning/SKILL.md) skill — hook → suspense → payoff; never spoil; build to a shocker |
