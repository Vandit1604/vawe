...
identical-looking fragments, one per brand, would have failed at the one thing it exists for: 41 themes
need 41 kits, not one kit in 41 colours, and a fragment built from the kit should still look like a
