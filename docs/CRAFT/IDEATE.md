...
**From a reference video**, once it has been studied (`make study`, `docs/CRAFT/REFERENCE-STUDY.md`):
...
(`docs/CRAFT/REFERENCE-STUDY.md` says the same about `study.md`'s own columns).
