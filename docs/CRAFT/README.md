...
| [rules/README.md](rules/README.md) | writing or reading a docs/CRAFT/rules/<category>.json file, or wiring a new consumer of harness/lib/craft-rules.mjs | the rule-record schema, one worked example, the owner rules every record obeys, and why brief quotes the doc |
