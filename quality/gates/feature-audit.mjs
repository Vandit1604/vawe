...
// authored videos actually USE. No browser, no render. Pure JSON walk. This is a
// `lint`/`inspect`-style analogue: keep authored content honest against the framework's real capability,
