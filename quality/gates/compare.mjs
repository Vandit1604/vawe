// quality/gates/compare.mjs: VARIANT SELECTION. Render/extract a frame from each candidate and tile them
// into one labeled sheet so the author (human or agent) can pick the best. This is how taste gets
// applied without shipping the first draft.
//
// Usage:
//   node quality/gates/compare.mjs a.json b.json c.json --at 3 --out /tmp/compare.png
//   node quality/gates/compare.mjs out/a.mp4 out/b.mp4 --at 5
