...
destination: web
source: vawe-type-demo/SKILL.md worked example, rebuilt per engine-doctrine/EVALS.md as a real demo (was 6 layers / 10s)
...
<!--
  ...
  demo's clothes (skills/vawe-type-demo/SKILL.md's own warning).
