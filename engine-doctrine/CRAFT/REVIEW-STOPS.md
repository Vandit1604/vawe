...
hierarchy and the cobalt glow in `engine-doctrine/animation.html`.
...
It is slower per attempt and much faster per finished thing. The deck in `engine-doctrine/animation.html` was
