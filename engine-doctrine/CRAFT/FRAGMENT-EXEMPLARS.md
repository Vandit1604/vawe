...
identical-looking fragments, one per brand, would have failed at the one thing it exists for: 34 themes
need 34 kits, not one kit in 34 colours, and a fragment built from the kit should still look like a
