...
- `[ref: make grammar DOC=1]`: a measured catalog, not a gate. Nothing here blocks. Regenerate from `grammar/*.json` via `make study`; never hand-edit this file.
...
> GENERATED by `make grammar DOC=1` from `grammar/*.json`. Do not edit this file: edit the JSON
...
make grammar DOC=1                             # regenerates this page
```
