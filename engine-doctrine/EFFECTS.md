...
> GENERATED by `scripts/site/effects-catalog.mjs` (`make regen`) from the engine registries, it
...
---
_744 effects across 64 families. Regenerate: `make regen`._
