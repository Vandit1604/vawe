...
export const CATALOG = [
  ...
  { name: 'codeBlock.py', family: 'codeBlock', blurb: 'code card, python',
    props: { w: 540, dark: true, label: 'render.py', size: 19, lines: [
      { text: 'from shortwave import render', color: '#8898AA' }, { text: 'render("video.json")', color: '#E8ECF1' }] } },
  ...
  { name: 'terminal.install', family: 'terminal', blurb: 'install command',
    props: { w: 540, command: 'npm i shortwave', output: ['added 1 package', 'done in 1.2s'] } },
  ...
  { name: 'barChart.green', family: 'barChart', blurb: 'bars in success green',
    props: { w: 520, h: 240, color: '#16A34A', data: [{ label: 'Q1', value: 40 }, { label: 'Q2', value: 55 }, { label: 'Q3', value: 68 }, { label: 'Q4', value: 90 }] } },
  { name: 'lineChart.down', family: 'lineChart', blurb: 'declining trend (red)',
    props: { w: 540, h: 240, color: '#C0362C', label: 'churn', data: [{ label: 'M', value: 62 }, { label: 'T', value: 55 }, { label: 'W', value: 48 }, { label: 'T', value: 30 }] } },
  { name: 'donutChart.two', family: 'donutChart', blurb: 'two-segment ring',
    props: { w: 320, label: 'pass / fail', segments: [{ value: 88, color: '#16A34A', label: 'Pass' }, { value: 12, color: '#C0362C', label: 'Fail' }] } },
  { name: 'stackedBar.three', family: 'stackedBar', blurb: 'three-series stack',
    props: { w: 520, h: 260, series: [{ color: '#635BFF' }, { color: '#3ECF8E' }, { color: '#F6A417' }], data: [
  ...
  { name: 'gauge.full', family: 'gauge', blurb: 'gauge, complete (green)',
    props: { w: 300, value: 100, color: '#16A34A', label: 'passing' } },
  { name: 'progressRing.done', family: 'progressRing', blurb: 'ring, 100% (green)',
    props: { size: 150, value: 100, color: '#16A34A', label: 'complete' } },
  ...
  { name: 'notification.error', family: 'notification', blurb: 'toast, error',
    props: { w: 440, title: 'Render failed', body: 'em-dash in on-screen copy', accent: '#C0362C' } },
  ...
  { name: 'toast.error', family: 'toast', blurb: 'snackbar, error + retry',
    props: { w: 420, message: 'Upload failed', action: 'Retry', icon: '!', accent: '#C0362C' } },
  { name: 'toast.info', family: 'toast', blurb: 'snackbar, info',
    props: { w: 420, message: '3 blocks added to the scene', action: 'Undo', icon: 'i', accent: '#635BFF' } },
  ...
  { name: 'banner.info', family: 'banner', blurb: 'banner, info (blurple)',
    props: { w: 560, text: 'Read the migration guide', cta: 'Open', accent: '#635BFF', icon: 'i' } },
