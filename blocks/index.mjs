...
const FACTORIES = { ...APP, ...CHARTS, card, codeBlock, terminal, loadingBar, deploySuccess, browserFrame, pillRow,
  colorCycle, stripeCard, diff, quote, notification, kpiRow, callout, comparison, captions,
  pricingCard, profileCard,
  ...
  logoWall, badge, banner, spinner, lowerThird, searchEngine,
