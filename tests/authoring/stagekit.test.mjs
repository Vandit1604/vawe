// tests/authoring/stagekit.test.mjs: the kit-identity check actually catches drift.
//   node tests/authoring/stagekit.test.mjs
import assert from 'node:assert/strict';
import { buildKit, kitCheck, extractKitBlock, MIN_VIDEO_TEXT_PX } from '../../harness/lib/stagekit.mjs';
