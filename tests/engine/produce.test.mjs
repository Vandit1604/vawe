// tests/engine/produce.test.mjs: the runnable self-check for produceBaseline's inferred-cut default
...
// cut over silence: this is the arithmetic signal, not a taste call ----
{
  ...
  const { chooseCutStyles } = await import('../../core/timeline/junctions.js');
  const { layerSpeedAt } = await import('../../core/timeline/velocity-cut.js');
