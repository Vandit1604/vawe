...
theme: satara: warm off-white paper, one trail-orange accent, geometric rounded sans (Plus Jakarta Sans), snappy easeOutBack motion; the only theme in themes/ that reads as paper-and-sunlight (outdoor, warm, spatial) rather than a dashboard or a night mode, confirmed against `make arsenal THEME=satara`
