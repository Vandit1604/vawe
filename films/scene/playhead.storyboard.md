...
<!--
  ...
  Proof is a pixel count, never an eye: `node harness/dev/bar-probe.mjs films/scene/playhead.json`
  ...
  `films/scene/_lightfall.html` WAS CONSIDERED AND REJECTED. It is a good generated light field, 42
