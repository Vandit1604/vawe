  ...
  return (
    ...
    <div className={variant === "pill" ? "wrap navhold" : "wrap"}>
      <header className={`bar ${variant}`}>
        ...
        {/* No star count: the repo is private, so "79" was a number the site could not back — and
            an unbacked number invites the reader to notice the absence. Restore it when the repo is
            public AND the count is fetched, never hard-coded. */}
        <a className="ghbtn" href="https://github.com/Vandit1604/vawe">
