...
<span class="p">→</span> <span class="a">make probe</span>  <span class="s">// verifies it</span>`,
  ...
  },
  {
    slug: "blocks",
    kicker: "02 / blocks",
    title: "153 components, theme-aware.",
    tagline: "A vetted library you drop into a scene.",
    demo: "/assets/showcase/data.mp4",
    poster: "/assets/showcase/data.jpg",
    body: [
      "Charts, cards, code, terminals, KPIs, browser frames, tweets, chat bubbles. 153 blocks across 68 families, each deterministic and reskinnable to any brand via CSS variables and a color ramp.",
